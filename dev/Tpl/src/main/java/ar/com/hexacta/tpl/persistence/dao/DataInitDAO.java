...
public class DataInitDAO implements DataInitRepository {
    ...
    private void createData() {
         ...
         * "El mejor libro sobre dinosaurios!"); commentDAO.save(comment1);
         * LOG.info("Created comment " + comment1.getId()); Comment comment2 =
         * new Comment("Godzila", "sdlkfj@gmail.com",
         * "No me gusto que no mencionen Hello Kitty");
         * commentDAO.save(comment2); LOG.info("Created comment " +
         * comment2.getId()); Comment comment3 = new Comment("Jesus Reloaded",
         * "religioso@islam.com", "Por Al-lah!"); commentDAO.save(comment3);
         * LOG.info("Created comment " + comment3.getId()); Comment comment4 =
         * new Comment("Book Not Found", "User Not Found",
         * "Me hubiese gustado que el libro tuviese algo escrito");
         * commentDAO.save(comment4); LOG.info("Created comment " +
         * comment4.getId());
         * 
         * // TESTING Comentarios
         * LOG.info("\n <<<<<<<<<<<<< Retrieving Comments... >>>>>>>>>>>>>>>>>"
