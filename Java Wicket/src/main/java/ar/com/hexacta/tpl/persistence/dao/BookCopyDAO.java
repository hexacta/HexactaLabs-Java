...
@Repository
public class BookCopyDAO extends AbstractDAO<BookCopy> implements
		BookCopyRepository {
	...
	public BookCopy findFreeCopy(final Long bookId) {
		...
		criteria.add(Restrictions.like("state", BookCopy.STATE_FREE));
		List<BookCopy> result = (List<BookCopy>) this.getHibernateTemplate()
